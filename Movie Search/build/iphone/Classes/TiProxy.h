...
//Rare exceptions to indicate a bug in the _themoviedatabasesearch code (Eg, function that a subclass should have implemented)
...
/**
 The base class for TheMovieDatabaseSearch proxies.
 */
