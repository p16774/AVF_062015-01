...
/**
 Base class for all WunderlandWeatherApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the WunderlandWeatherApp view hierarchy (such as wrapped iOS UIViews) was touched.
