...
/**
 Base class for all TheMovieDatabaseSearch views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the TheMovieDatabaseSearch view hierarchy (such as wrapped iOS UIViews) was touched.
