...
//Rare exceptions to indicate a bug in the _wunderlandweatherapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for WunderlandWeatherApp proxies.
 */
